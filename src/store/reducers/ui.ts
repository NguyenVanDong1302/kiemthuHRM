...
export const uiSlice = createSlice({
  ...
  reducers: {
    ...
    toggleEditDetail: (state, { payload }) => {
      state.isFlagActiveEdit = state.isFlagActiveEdit === true ? false : true;
    },
    dataUploadReducer: (state, { payload }) => {
        state.dataUpload = payload.data
    }
  }
});
